import{E as h}from"./BufferObject-DVepJ7vL.js";import{r as c}from"./Program-Do7oUrQX.js";import{x as g,s as y}from"./Program-Do7oUrQX.js";import{cu as F}from"./index-CorgkmYx.js";import{t as p}from"./NestedMap-GuqgquCN.js";import{e as O,a as P}from"./ProgramTemplate-CrjRRSf3.js";import{o as A}from"./VertexArrayObject-CdgTI6fD.js";class x{constructor(e){this._rctx=e,this._store=new p}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,t,o,n){const r=this._store.get(e,t);if(r!=null)return r.ref(),r;const s=new c(this._rctx,e,t,o,n);return s.ref(),this._store.set(e,t,s),s}get test(){}}function u(f){const{options:e,value:t}=f;return typeof e[t]=="number"}function $(f){let e="";for(const t in f){const o=f[t];if(typeof o=="boolean")o&&(e+=`#define ${t}
