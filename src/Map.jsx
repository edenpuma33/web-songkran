...
const Map = ({ optionSelected }) => {
  ...
  const MARKER2 = [
    ...
    { id: 10, position: [19.4845544, 98.4376777], label: "เมืองล้านนา (เชียงใหม่)" },
    { id: 11, position: [18.8036471, 102.1212900], label: "ประเทศลาว" },
    { id: 12, position: [21.2829153, 99.6118559], label: "ชุมชนไทใหญ่" },
    { id: 13, position: [20.1232043, 105.1402150], label: "เมืองเวียดนามตอนบน" },
    { id: 14, position: [11.8662927, 103.8008617], label: "เมืองจามปา (เวียดนามตอนใต้)" },
    { id: 15, position: [8.3016850, 99.7687008], label: "เมืองนครศรีธรรมราช" },
